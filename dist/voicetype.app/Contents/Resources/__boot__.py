...
_recipes_pil_prescript(['IcnsImagePlugin', 'GifImagePlugin', 'Hdf5StubImagePlugin', 'Jpeg2KImagePlugin', 'MspImagePlugin', 'TiffImagePlugin', 'PdfImagePlugin', 'WebPImagePlugin', 'McIdasImagePlugin', 'SpiderImagePlugin', 'BmpImagePlugin', 'PpmImagePlugin', 'JpegImagePlugin', 'FtexImagePlugin', 'FitsStubImagePlugin', 'IcoImagePlugin', 'PsdImagePlugin', 'EpsImagePlugin', 'PcxImagePlugin', 'BufrStubImagePlugin', 'SunImagePlugin', 'PixarImagePlugin', 'TgaImagePlugin', 'XpmImagePlugin', 'MpegImagePlugin', 'IptcImagePlugin', 'SgiImagePlugin', 'PngImagePlugin', 'DcxImagePlugin', 'ImtImagePlugin', 'GbrImagePlugin', 'XbmImagePlugin', 'ImImagePlugin', 'FliImagePlugin', 'BlpImagePlugin', 'MicImagePlugin', 'WmfImagePlugin', 'DdsImagePlugin', 'XVThumbImagePlugin', 'GribStubImagePlugin', 'PcdImagePlugin', 'CurImagePlugin', 'MpoImagePlugin', 'PalmImagePlugin', 'FpxImagePlugin'])
